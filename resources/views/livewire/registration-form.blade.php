<div class="flex h-screen w-full">
    ...
    <div class="lg:w-7/12 flex items-center justify-center">
        <div class="border bg-white border-gray-200 rounded-lg p-4 flex flex-col min-w-xl">
    ...
    <div class="grow bg-linear-to-b from-blue-500 to-blue-800 text-white flex flex-col px-8 py-2">
